...
فیلدهای `text` از Markdown درون‌خطی و HTML پشتیبانی می‌کنند.

برچسب‌های HTML خام همچنان حفظ می‌شوند. وقتی می‌خواهید کروشه‌های زاویه‌ای را به‌صورت متن نمایش دهید، از کد درون‌خطی یا موجودیت‌های HTML استفاده کنید.
...
فیلدهای `text` و `docFooterText` از Markdown درون‌خطی و HTML پشتیبانی می‌کنند.
...
مقادیر رشته‌ای `prev` و `next` از Markdown درون‌خطی و HTML پشتیبانی می‌کنند.
