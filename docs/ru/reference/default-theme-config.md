...
Если вы хотите отключить его для всех режимов просмотра, используйте `outline: false`.
...
Настройка нижнего колонтитула. Вы можете добавить сообщение или текст об авторских правах в нижний колонтитул, однако он будет отображаться только в том случае, если страница не содержит боковой панели. Это объясняется соображениями дизайна.
